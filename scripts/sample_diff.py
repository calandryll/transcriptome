...
os.system("cuffdiff -p 4 -L Control,Vibrio -o %s %s %s/control_2.bam,%s/control_3.bam,%s/control_4.bam %s/treat_1.bam,%s/treat_2.bam,%s/treat_3.bam" % (output_dir, merged, control_lane, control_lane, control_lane, treat_lane, treat_lane, treat_lane))
